...
export const INDICATOR = Object.freeze({
  ...
  MRZ_FIELD_RECONSTRUCTED: 'MRZ_FIELD_RECONSTRUCTED',
  MRZ_ABSENT: 'MRZ_ABSENT',
  LOCALIZED_TEXT_EDIT: 'LOCALIZED_TEXT_EDIT',
  PHOTO_REPLACEMENT_INDICATOR: 'PHOTO_REPLACEMENT_INDICATOR',
  /** Raised only when image forensics AND face comparison independently implicate the portrait. */
  PHOTO_REPLACEMENT_CORROBORATED: 'PHOTO_REPLACEMENT_CORROBORATED',
