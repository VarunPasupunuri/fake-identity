...
const FIXTURES = {
  ...
  aadhaar: (sc) => [
    ...
    sc === 'missing_fields' ? '' : 'Name: PRIYA DEMO SHARMA',
    "Father's Name: RAMESH DEMO SHARMA", 'Date of Birth: 1994-07-22', 'Sex: FEMALE',
    sc === 'missing_fields' ? '' : `${sc === 'suspicious' ? '9999 8888 7777' : '2222 3333 4444'}`,
    'VID: 9100 1234 5678 9012', 'Address: 21 TEST COLONY, SAMPLE CITY, DEMOLAND 500001',
    'Aadhaar is proof of identity, not of citizenship or date of birth.', 'DEMONSTRATION DATA — NOT A REAL AADHAAR',
  ].filter(Boolean).join('\n'),
...
export function fixtureBarcode(documentType, scenario = 'clean') {
  ...
  const codes = {
    ...
    aadhaar: { id: '2222 3333 4444', name: 'PRIYA DEMO SHARMA' },
